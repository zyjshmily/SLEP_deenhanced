function [x, funVal, ValueL, res]=overlapping_LeastR_yj(A, y, z, opts,CTLTR)
%
%%
...
if (opts.mFlag==0 && opts.lFlag==0)    
    ...
    for iterStep=1:opts.maxIter
        ...
        while (1)
            ...
            % projection
            %% lambda1用-位置1
            [x,gap,penalty2]=overlapping(v,  n, groupNum, lambda1(1)/L, lambda2/L,...
                w, G, Y, maxIter2, flag2, tol2, lambda_vector);
        ...
        funVal(iterStep)=Axy'* Axy/2 + sum(lambda_vector .* abs(x)) + lambda2 *penalty2 (1);

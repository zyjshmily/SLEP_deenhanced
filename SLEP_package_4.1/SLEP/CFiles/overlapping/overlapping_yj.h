...
void identifySomeZeroEntries(double * u, int * zeroGroupFlag, int *entrySignFlag,
        ...
        int p, int g, double * w, double *G, double *lambda_vector){
     ...
     */
    for(i=0;i<p;i++){
        if (v[i]> lambda_vector[i]){
            u[i]=v[i]-lambda_vector[i];
...
void overlapping_gd(double *x, double *gap, double *penalty2,
        ...
        double *w, double *G, double *Y, int maxIter, int flag, double tol, double *lambda_vector){
...
void overlapping_yj(double *x, double *gap, double *penalty2,
        double *v, int p, int g, double lambda1, double lambda2,
        double *w, double *G, double *Y, int maxIter, int flag, double tol, double *lambda_vector){
    ...
    switch(flag){
        ...
        case 1:
            ...
            w, G, Y, maxIter, flag,tol, lambda_vector);
            break;
        case 2:
        case 3:
            ...
            v,  p, g, lambda1, lambda2,
            w, G, Y, maxIter, flag-2,tol, lambda_vector);
        ...
        default:
            ...
            overlapping_agd(x, gap, penalty2,
            v,  p, g, lambda1, lambda2,
            w, G, Y, maxIter, 0,tol, lambda_vector);
            break;
    }

...
% This is an example for running the function tree_mtLeastR
%
%  Problem:
%
%  min  1/2 sum_j || A_j x_j - y_j||^2 + z * sum_i sum_j w_j ||x^i_{G_j}||
%
...
m=900;  n=80;       % The data matrix is of size m x n
k=100;
...
% 
% tic;
% % [x1, funVal1, ValueL1]= tree_mtLeastR(A, y, z, opts);
% toc;
...
% samples for different tasks
opts.ind=[0, 10:10:900]; % each task has 10 samples

%% Run the function
z=0.5;

tic;
[x2, funVal2, ValueL2]= tree_mtLeastR(A, y, z, opts);
toc;
